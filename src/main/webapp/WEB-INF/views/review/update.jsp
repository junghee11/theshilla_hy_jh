...
<!-- header 끝 -->
	<main>
		<section class="content_wrap1">
			...
			<div class="log1">
			<form method="POST">
                <p>평점 : <input type="number" style="width:50px;" max="10" min="1" value="${data.room_rating}" name="room_rating"></p>
				<p><input type="text" name="review_title" value="${data.review_title}"></p>
                <p>
                    <textarea style="width:300px;" name="review_content" rows="10">${data.review_content}</textarea>
                <input type="hidden" name="id" value="${data.id}">
                <input type="hidden" name="type" value="${data.type }">
                <input type="hidden" name="date_in" value="${data.date_in}">
