...
<link href="https://fonts.googleapis.com/css2?family=Nanum+Myeongjo:wght@400;700;800&display=swap" rel="stylesheet">
	...
	<link rel="stylesheet" href="../resources/css/update.css?after">
	...
	<main>
		<section class="content_wrap1">
			...
			<div class="log1">
				...
				<input type="text" name="id" value="${data.id }" readonly style="border: none; outline:none;" ><br>
				...
				<label for="log_btn" style="opacity:0;">회원정보 수정</label>
				<input type="submit" value="회원정보 수정" id="update_btn">
			</div>
			</form>
		</section>
		<!-- content_wrap1 끝 -->
